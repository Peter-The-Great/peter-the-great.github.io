        ...
        <TopPart>
          <LinkHeader>
            ...
            <Title>
              ...
              {titleImg ?
                <img src={titleImage} alt="titleimg" className="handle" /> :
                <h1>{name}</h1>
              }
                    ...
                    return (
                      <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                        <LinkBox className="socialIcon">
                          <img src={i.icon} alt="social-icon" style={{ filter: 'var(--img)' }} />
                        </LinkBox>
                      </a>
                    )
                  })
              ...
              <h3>{install[0].type}</h3>
              {
                install.map((i) => {
                  return (
                    <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                      <LinkBox>
                        <LinkTitle><img src={i.icon} alt="LinkTitle" style={{ filter: 'var(--img)' }} /> {i.title}</LinkTitle> <NewUp />
                      </LinkBox>
                    </a>
                  )
                })
                  ...
                  <h3>{nfts[0].type}s</h3>
                  {
                    nfts.map((i) => {
                      return (
                        <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                          <LinkBox>
                            <LinkTitle><img src={i.icon} alt="" style={{ filter: 'var(--img)' }} /> {i.title}</LinkTitle> <NewUp />
                          </LinkBox>
                        </a>
                      )
                    })
